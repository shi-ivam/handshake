...
const Create = (props) => {
    ...
    const [details, setDetails] = useState({ firstName: 'John', lastName: 'Doe', description: 'Something...', email: '',address:'123 John',street:'John Street',city:'New York',country:'United States',pincode:'10001' });
    // useEffect(() => {
    //     console.log(
    //        )
    // }, []);
